...
import { Info, Waves, Square, Triangle, Minus, Lock } from 'lucide-react';
...
const FrequencyPanel: React.FC = () => {
  ...
  const handleFrequencyInput = (channelId: number, value: string) => {
    ...
    if (channelId > 1) {
      return; // Block interaction for channels 2-4 in free tier
    }
  ...
  const isChannelLocked = (channelId: number) => {
    return channelId > 1; // Channels 2-4 are locked in free tier
  };
              ...
              <div className="mb-3 md:mb-4">
                <input
                  ...
                  className={`w-full appearance-none bg-transparent 
                    ...
                    ${state.isPlaying && !isLocked ? getIntensityClass(channel.frequency) : ''}
